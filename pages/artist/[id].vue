<template>
    <div class="wrapped">
        <div class="h-[285px] w-full z-0 artistbackimage"
            ...
            <div class="p-6 box1 mt-[-200px]"
                ...
                <div>
                    <div class="grid grid-cols-2">
                        ...
                        <div class="flex items-end justify-end"><NuxtLink :to="`/artist/${$route.params.id}/discography/all`"><h1 class="hover:cursor-pointer hover:underline text-[14px] mb-4 items-end text-[#b3b3b3] text-end" style="font-family: SpotifyMixBold;">Show all</h1></NuxtLink></div>
                    </div>
                    <div class="flex my-2 gap-2">
                        ...
                        <div id="singleBtn" @click="setActiveTab('singles')"
                            ...
                            class="py-1 px-3 rounded-[9999px] select-none" v-if="singles.length !== 0">Singles and EPs</div>
                        <div id="compilationBtn" @click="setActiveTab('compilation')"
                            :class="activeTab === 'compilation' ? 'activeB' : 'inactiveB'"
                            class="py-1 px-3 rounded-[9999px] select-none" v-if="compilations.length !== 0">Compilations</div>
                    </div>
                </div>
